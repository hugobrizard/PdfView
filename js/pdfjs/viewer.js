...
'use strict';
function startViewer(vUrl, locale){//TODO: added
var DEFAULT_URL = vUrl;
...
var PDFFindBar = (function PDFFindBarClosure() {
  function PDFFindBar(options) {
    ...
    var self = this;
    if(this.toggleButton) {//TODO: added
...
var PDFViewerApplication = {
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    var pagesCount = pdfDocument.numPages;
    if(document.getElementById('numPages')) {//TODO: added
    document.getElementById('numPages').textContent =
      mozL10n.get('page_of', {pageCount: pagesCount}, 'of {{pageCount}}');
    }//TODO: added
    if(document.getElementById('pageNumber')) {//TODO: added
...
function webViewerInitialized() {
  ...
  if (!PDFViewerApplication.supportsPrinting) {
      if(document.getElementById('print')) {//TODO: added
    document.getElementById('print').classList.add('hidden');
      }//TODO: added
      if(document.getElementById('secondaryPrint')) {//TODO: added
    document.getElementById('secondaryPrint').classList.add('hidden');
      }//TODO: added
  }

  if (!PDFViewerApplication.supportsFullscreen) {
      if(document.getElementById('presentationMode')) {//TODO: added
    document.getElementById('presentationMode').classList.add('hidden');
      }//TODO: added
      if(document.getElementById('secondaryPresentationMode')) {//TODO: added
    document.getElementById('secondaryPresentationMode').
  ...
  if (PDFViewerApplication.supportsIntegratedFind) {
      if(document.getElementById('viewFind')) {//TODO: added
    document.getElementById('viewFind').classList.add('hidden');
      }//TODO: added
  }

  // Suppress context menus for some controls
  if(document.getElementById('scaleSelect')) {//TODO: added
...
if(document.getElementById('sidebarToggle')) {//TODO: added
...
if(document.getElementById('previous')) {//TODO:added
  document.getElementById('previous').addEventListener('click',
    function() {
      PDFViewerApplication.page--;
    });
    }//TODO:added
if(document.getElementById('next')) {//TODO:added
  document.getElementById('next').addEventListener('click',
    function() {
      PDFViewerApplication.page++;
    });
    }//TODO:added
if(document.getElementById('zoomIn')) {//TODO:added
  document.getElementById('zoomIn').addEventListener('click',
    function() {
      PDFViewerApplication.zoomIn();
    });
    }//TODO:added
if(document.getElementById('zoomOut')){//TODO:added
...
if(document.getElementById('openFile')) {//TODO:added
...
if(document.getElementById('download')) {//TODO:added
...
document.addEventListener('pagerendered', function (e) {
  ...
  if (document.getElementById('pageNumber') && pageNumber === PDFViewerApplication.page) {//TODO: document.getElementById('pageNumber') added
...
window.addEventListener('change', function webViewerChange(evt) {
  ...
  if(document.getElementById('viewBookmark')) {//TODO: added
...
window.addEventListener('scalechange', function scalechange(evt) {
  ...
  var predefinedValueFound = selectScaleOption(evt.presetValue ||
                                               '' + evt.scale);
  if (document.getElementById('customScaleOption') && !predefinedValueFound) {//TODO: added document.getElementById('customScaleOption')
...
window.addEventListener('pagechange', function pagechange(evt) {
  ...
  if(document.getElementById('firstPage')) {//TODO: added
    document.getElementById('firstPage').disabled = (page <= 1);
  }//TODO: added
  if(document.getElementById('lastPage')) {//TODO: added
